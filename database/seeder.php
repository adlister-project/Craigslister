...
$ads = [
  ...
  ['title' => 'Leonardo da Vinci\'s Codex Hammer',                      'description' => 'As the ultimate Renaissance man, Leonardo da Vinci meticulously recorded his thoughts, musings and sketches in journals throughout his life. Of the 30 that remain, his most famous is the Codex Hammer, named for the British nobleman who acquired the 72-page journal in 1717.',                                      'price' => '30802500'],
  ['title' => '1957 Ferrari 250 Testa Rossa',                           'description' => 'There are only 21 other cars like it, but none of them are quite so expensive. While the 1957 Testa Rossas won 10 of the 19 international races that they entered from 1958 and 1961, this particular vehicle never finished better than fourth. No matter; the car\'s finest quality is not its speed but its beauty.', 'price' => '12200000']
];
...
$stmt2 = $dbc->prepare('INSERT INTO ads (title, description, price) VALUES (:title, :description, :price)');
...
$stmt7 = $dbc->prepare('INSERT INTO phone_carriers (carrier_domain) VALUES (:carrier_domain)');
