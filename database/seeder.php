...
$ads = [
  ...
  ['user_id' => '2', 'title' => 'Leonardo da Vinci\'s Codex Hammer',                      'description' => 'As the ultimate Renaissance man, Leonardo da Vinci meticulously recorded his thoughts, musings and sketches in journals throughout his life. Of the 30 that remain, his most famous is the Codex Hammer, named for the British nobleman who acquired the 72-page journal in 1717.',                                      'price' => '30802500', 'date_posted' => '2008-04-23'],
...
$stmt2 = $dbc->prepare('INSERT INTO ads (user_id, title, description, price, date_posted) VALUES (:user_id, :title, :description, :price, :date_posted)');
...
foreach ($ads as $ad) {
  ...
  $stmt2->bindValue(':date_posted', $ad['date_posted'], PDO::PARAM_STR);
  $stmt2->execute();
}
